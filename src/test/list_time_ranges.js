...
function listTimeRanges(data, cb) {
	...
	session.listTimeRanges({granularity: "HOURS", filter: {}}, function (err, res) {
...
async.series([common.login, common.getDeveloperAppKeys, listTimeRanges, common.logout], function (err, res) {
