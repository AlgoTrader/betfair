...
var actions = [common.login, common.listMarketCatalogue, common.selectMarket, placeOrders, replaceOrders, updateOrders, cancelOrdersPartial, cancelOrdersFull, common.logout];
