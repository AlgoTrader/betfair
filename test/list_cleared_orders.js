...
// list countries
function listClearedOrders(data, cb) {
    if (!cb)
        cb = data;

    session.listClearedOrders({betStatus:'SETTLED'}, function (err, res) {
...
async.series([common.login, common.getDeveloperAppKeys, listClearedOrders, common.logout], function (err, res) {
