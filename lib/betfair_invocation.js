...
var ForeverAgentSSL = require('forever-agent').SSL;
...
var apiTypes = {
    ...
    betting: {type: "SportsAPING", version: "v1.0", service: "https://api.betfair.com:443/exchange/betting/json-rpc/v1/"},
    scores: {type: "ScoresAPING", version: "v1.0", service: "https://api.betfair.com:443/exchange/scores/json-rpc/v1/"}
};
