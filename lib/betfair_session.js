...
BetfairSession.prototype.logout = function (cb) {
	...
	function onLogoutResult(err,res) {
		console.log('logout');
		cb(err,res);
	}
	...
	switch (this.loginType) {
		case 'interactive':
			auth.interactiveLogout(self.sessionKey, onLogoutResult);
			break;
		case 'bot':
			auth.botLogout(self.sessionKey, onLogoutResult);
			break;
	}
}
...
BetfairSession.prototype.keepAlive = function (cb) {
	...
	function onKeepAliveResult(err,res) {
	...
	switch (this.loginType) {
		case 'interactive':
			auth.interactiveKeepAlive(self.sessionKey, onKeepAliveResult);
			break;
		case 'bot':
			auth.botKeepAlive(self.sessionKey, onKeepAliveResult);
			break;
	}
}
