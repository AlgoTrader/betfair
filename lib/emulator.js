...
exports.setMarketEmulationMode = function(marketId, isEnabled) {
    core.setMarketEmulationMode(marketId,isEnabled);
}

exports.getMarketEmulationMode= function(marketId) {
    return core.getMarketEmulationMode(marketId);
}
